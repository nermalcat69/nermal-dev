...
Every action Nermalcan perform is in here, whether or not it has a keybinding —
...
<Frame caption="Placeholder — screenshot: the command palette open over a terminal, grouped results">
  <img src="/images/placeholder.svg" alt="The Nermalcommand palette" />
</Frame>
...
If no agent is running, Nermalsays so rather than typing into your shell.
