...
<Frame caption="Placeholder — screenshot: the side panel showing the Info tab beside a terminal">
  <img src="/images/placeholder.svg" alt="The Nermalside panel" />
</Frame>

## Info

Everything Nermalknows about the focused pane, in one column:
...
where" — the same data `Nermalprocs` prints. A port row copies `localhost:PORT`,
