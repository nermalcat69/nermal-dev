...
<Frame caption="Placeholder — screenshot: the theme picker with light and dark sections">
  <img src="/images/placeholder.svg" alt="The Nermaltheme picker" />
</Frame>

## Following the system

Turn on **Sync with system** and pick a theme for each appearance. Nermalfollows
...
Drop an `.itermcolors` file into the themes folder and Nermalreads it directly —
no conversion step.

<Note>
  A theme file Nermalcould not load is listed in Settings under **Not loaded from
