...
Agents → Install the Nermalcommand on PATH**.

<Tip>
  Inside a Nermalpane the CLI works regardless of PATH, because panes inherit the
  app's environment.
</Tip>

## Updating

Nermalchecks for updates every six hours and can update itself: **Settings →
