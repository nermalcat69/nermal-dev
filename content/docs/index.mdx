...
<Frame>
  <img src="/images/hero.webp" alt="Nermalshowing a sidebar of agent sessions across several repositories" />
</Frame>
...
<CardGroup cols={2}>
  <Card title="Sessions that outlive the app" icon="power-off" href="/getting-started/concepts">
    A background server owns your shells, not the window. Quit Nermaland your
